...
const shapeDict = {
    ...
    "circle": "clclclclclclclc",
    "square": "sqsqsqsqsqsqsqsqsqs",
    "triangle": "trtrtrtrttrrtrt",
    "rectangle": "rcrcrcrcrcrcrc",
    "plus-cross": "++++++++++++++++",
    "x-cross": "xxxxxxxxxxxxxxxx",
    "heart": "3333333333333333"
}
...
function playGame() {
    ...
    */
    ...
    shapeRadio.name = "numAnswerRadios";
    shapeRadio.id = "numAnswer_" + i;
    ...
    console.log("Answer " + i + ": " + answerBank[i]);
    sendData(shapeDict[answerBank[i]]);
